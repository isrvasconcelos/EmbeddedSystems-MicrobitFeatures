...
GEN_ABSOLUTE_SYM(CONFIG_I2C_BITBANG, 1);
GEN_ABSOLUTE_SYM(CONFIG_I2C_GPIO, 1);
GEN_ABSOLUTE_SYM(CONFIG_I2C_GPIO_0, 1);
GEN_ABSOLUTE_SYM(CONFIG_I2C_GPIO_0_NAME, 1);
GEN_ABSOLUTE_SYM(CONFIG_I2C_GPIO_0_GPIO, 1);
GEN_ABSOLUTE_SYM(CONFIG_I2C_GPIO_0_SCL_PIN, 19);
GEN_ABSOLUTE_SYM(CONFIG_I2C_GPIO_0_SDA_PIN, 20);
...
GEN_ABSOLUTE_SYM(CONFIG_I2C_0_IRQ_PRI, 1);
GEN_ABSOLUTE_SYM(CONFIG_I2C_NRF5, 1);
GEN_ABSOLUTE_SYM(CONFIG_I2C_NRF5_0_GPIO_SDA_PIN, 30);
GEN_ABSOLUTE_SYM(CONFIG_I2C_NRF5_0_GPIO_SCL_PIN, 0);
...
GEN_ABSOLUTE_SYM(CONFIG_SYS_LOG_SENSOR_LEVEL, 0);
...
GEN_ABSOLUTE_SYM(CONFIG_SYS_LOG_DEFAULT_LEVEL, 4);
